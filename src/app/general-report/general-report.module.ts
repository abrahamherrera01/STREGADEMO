...
import { ComparisonCustomersWithComplaintsComponent } from './sales/components/comparison-customers-with-complaints/comparison-customers-with-complaints.component';
...
@NgModule({
  declarations: [
    ...
    ComparisonCustomersWithComplaintsComponent
  ],
  imports: [
    CommonModule,
